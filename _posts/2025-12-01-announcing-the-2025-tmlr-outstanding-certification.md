...
description: 'The 2025 TMLR Outstanding Certification is awarded to “Mantis: Interleaved Multi-Image Instruction Tuning”.'
medium_url: https://medium.com/@TmlrOrg/announcing-the-2025-tmlr-outstanding-certification-e26d548ff011
---

By [Gautam Kamath](http://www.gautamkamath.com/), on behalf of the 2025 TMLR Outstanding Paper Committee: [Pablo Samuel Castro](https://psc-g.github.io/), [Pin-Yu Chen](https://sites.google.com/site/pinyuchenpage/home), [Vincent Dumoulin](https://vdumoulin.github.io/), [Amir-massoud Farahmand](https://academic.sologen.net/), [Andreas Kirsch](https://www.blackhc.net/), [Jasper Lee](https://jasperchlee.github.io/), [Jeffrey Pennington](https://scholar.google.com/citations?user=cn_FoswAAAAJ), [Colin Raffel](https://colinraffel.com/), [Chang Xu](http://changxu.xyz/).

The 2025 TMLR Outstanding Paper Committee is pleased to award the Outstanding Certification to the following paper:

- [Mantis: Interleaved Multi-Image Instruction Tuning](https://openreview.net/forum?id=skLtdUVaJa), by Dongfu Jiang, Xuan He, Huaye Zeng, Cong Wei, Max Ku, Qian Liu, Wenhu Chen\*
...
- [Causal Reasoning and Large Language Models: Opening a New Frontier for Causality](https://openreview.net/forum?id=mqoxLkX210), by Emre Kiciman, Robert Ness, Amit Sharma, Chenhao Tan
- [Cognitive Architectures for Language Agents](https://openreview.net/forum?id=1i6ZCvflQJ), by Theodore Sumers, Shunyu Yao, Karthik Narasimhan, Thomas Griffiths
- [Gradient Scarcity in Graph Learning with Bilevel Optimization](https://openreview.net/forum?id=10YJTIsVYq), by Hashem Ghanem, Samuel Vaiter, Nicolas Keriven
...
Finally, in [previous](https://medium.com/@TmlrOrg/announcing-the-first-tmlr-outstanding-certification-3a2838c08cda) [years](https://medium.com/@TmlrOrg/announcing-the-2024-tmlr-outstanding-certification-65f25d05c37c), we have listed all expert reviewers who were kind enough to share their opinions and expertise. Given that the recent [OpenReview security incident](https://openreview.net/forum/user%7Cstatement_regarding_api_security_incident) is fresh in peoples’ minds, and the fact that we did not previously notify experts that their names might be publicly acknowledged, we felt that it might be a bit tone-deaf to reveal their names right now, even without explicit association to which papers they opined on. Nonetheless, they are free to list this information publicly if they so desire. In future years, we will explicitly warn experts that their name will appear in an acknowledgment.
